...
GLOBAL_DECAY_PER_RUN=$(read_config '.global_instincts.decay_per_run // 0.03' 2>/dev/null || echo "0.03")
GLOBAL_DECAY_PER_RUN=$(validate_numeric "$GLOBAL_DECAY_PER_RUN" "$_NUMERIC_NONNEG_FLOAT" "0.03")
GLOBAL_DECAY_FLOOR=$(read_config '.global_instincts.decay_floor // 0.1' 2>/dev/null || echo "0.1")
GLOBAL_DECAY_FLOOR=$(validate_numeric "$GLOBAL_DECAY_FLOOR" "$_NUMERIC_NONNEG_FLOAT" "0.1")
